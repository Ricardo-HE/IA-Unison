...
class ProblemaNreinas(genetico.Problema):
    ...
    def costo(self, estado):
        ...
        @return: Un valor numérico, mient   ras más pequeño, mejor es el estado.
...
if __name__ == "__main__":
    ...
    #
    #       32:
    #           Utilizando el AG: propuesto por Julio Waissmancon prob. de mutación 0.015
    #           Con poblacion de dimensión 64
    #           Con 200 generaciones
    #           Costo de la solución encontrada: 0
    #           Tiempo de ejecución en segundos: 1.774522304534912
    #       64:
    #
    #
    #
    ...
    for i in range(5):
        ...
        prob_mutacion = 0.0031
        n_poblacion = 100
        generaciones = 350

        alg_gen = genetico.GeneticoPermutaciones(ProblemaNreinas(100),
